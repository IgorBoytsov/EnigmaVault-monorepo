...
{
    public sealed record UpdateMetadataCommand(int IdSecret, string ServiceName, string? Url) : IRequest<Result<DateTime>>, IIdSecretDataHolder, IServiceNameDataHolder;
}